  ...
  render() {
    ...
    return (
      <div className={acctSelected ? `${selector}-parentDiv` : 'hidden'}>
        ...
        <Button
          selector={acctSelected ? `${selector}-backup` : 'hidden'}
          onButtonClick={this.handleBackupClick.bind(this)}
          prompt="backup"
        />
        <Button
          selector={acctSelected ? `${selector}-manage` : 'hidden'}
          onButtonClick={this.handleManageClick.bind(this)}
          prompt="manage"
        />
        <Button
          selector={acctSelected ? `${selector}-restore` : 'hidden'}
          onButtonClick={this.handleRestoreClick.bind(this)}
          prompt="restore"
        />
        <Select
          selector={showBackups ? `${selector}-restoreSelect` : 'hidden'}
